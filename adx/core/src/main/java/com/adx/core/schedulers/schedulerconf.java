...
@Designate(ocd = schedulerconf.ServiceConfig.class)
public class schedulerconf implements Runnable{
    @Reference
    ...
    @Activate
    public  void activate(schedulerconf.ServiceConfig serviceConfig){
    ...
    public void run() {
        try {
            ...
            myparam.put(ResourceResolverFactory.SUBSERVICE, "shivanshsystemuser");
